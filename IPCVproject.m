...
figure(11);imshowpair(img_L_rec,img_LM_rec);
...
[img_L_recm,img_LM_recm]=rectifyStereoImages(mask_L2, mask_M2, ...
    stereoParamsC1LM,'OutputView','full');
figure(15);imshowpair(img_L_recm,img_LM_recm);
...
[dmap_LM,unrel_LM]=dispmap('S2',img_L_rec,img_LM_rec,img_L_recm);
%print -r150 -dpng dispLM.png
[dmap_MR,unrel_MR]=dispmap('S2',img_MR_rec,img_R_rec,img_MR_recm);
